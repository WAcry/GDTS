...
There is also a companion command-line utility to evaluate cron time expressions: <https://utils/gorhill/cronexpr/tree/master/cronexpr> (which of course uses this library).
...
Install
-------
    go get utils/gorhill/cronexpr

Usage
-----
Import the library:

    import "utils/gorhill/cronexpr"
    import "time"
...
API
---
<http://godoc.org/utils/gorhill/cronexpr>
