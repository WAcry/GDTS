...
[![GoDoc](https://godoc.org/utils/mongodb/mongo-go-driver/mongo?status.svg)](https://godoc.org/utils/mongodb/mongo-go-driver/mongo)
...
```bash
dep ensure -add utils/mongodb/mongo-go-driver/mongo
```
