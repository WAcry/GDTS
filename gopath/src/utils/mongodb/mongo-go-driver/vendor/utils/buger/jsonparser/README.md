[![Go Report Card](https://goreportcard.com/badge/utils/buger/jsonparser)](https://goreportcard.com/report/utils/buger/jsonparser) ![License](https://img.shields.io/dub/l/vibe-d.svg)
...
You also can view API at [godoc.org](https://godoc.org/utils/buger/jsonparser)
...
Note that keys can be an array indexes: `jsonparser.Set(data, []byte("http://utils"), "person", "avatars", "[0]", "url")`
...
* https://utils/Jeffail/gabs
* https://utils/a8m/djson
* https://utils/bitly/go-simplejson
* https://utils/antonholmquist/jason
* https://utils/mreiferson/go-ujson
* https://utils/ugorji/go/codec
* https://utils/pquerna/ffjson
* https://utils/mailru/easyjson
* https://utils/buger/jsonparser
...
https://utils/buger/jsonparser/blob/master/benchmark/benchmark_small_payload_test.go
...
utils/ugorji/go/codec | 8806 | 2176 | 31 
...
https://utils/buger/jsonparser/blob/master/benchmark/benchmark_medium_payload_test.go
...
| utils/ugorji/go/codec | 114719 | 6712 | 152 |
...
https://utils/buger/jsonparser/blob/master/benchmark/benchmark_large_payload_test.go
