...
Only [old versions of gRPC](https://utils/grpc/grpc-go/issues/1362) log this. etcd [>=v3.2.13 by default log this with DEBUG level](https://utils/coreos/etcd/pull/9080), thus only visible with `--debug` flag enabled.
...
[tuning]: ./tuning.md
[new_issue]: https://utils/coreos/etcd/issues/new
[backend_commit_metrics]: ./metrics.md#disk
[raft]: https://raft.github.io/raft.pdf
[backup]: https://utils/coreos/etcd/blob/master/Documentation/op-guide/recovery.md#snapshotting-the-keyspace
[chubby]: http://static.googleusercontent.com/media/research.google.com/en//archive/chubby-osdi06.pdf
[runtime reconfiguration]: https://utils/coreos/etcd/blob/master/Documentation/op-guide/runtime-configuration.md
[benchmark]: https://utils/coreos/etcd/tree/master/tools/benchmark
[benchmark-result]: https://utils/coreos/etcd/blob/master/Documentation/op-guide/performance.md
