...
To provision a 3 node etcd cluster on bare-metal, the examples in the [baremetal repo](https://utils/coreos/coreos-baremetal/tree/master/examples) may be useful.
