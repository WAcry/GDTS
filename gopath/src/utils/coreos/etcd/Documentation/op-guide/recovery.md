...
Previously, etcd panics on [membership mis-reconfiguration with wrong URLs](https://utils/coreos/etcd/issues/9173) (v3.2.15 or later returns [error early in client-side](https://utils/coreos/etcd/pull/9174) before etcd server panic).
