...
import (
	...
	"utils/coreos/etcd/client"
	"utils/coreos/etcd/clientv3"
	"utils/coreos/etcd/embed"
	"utils/coreos/etcd/etcdserver"
	"utils/coreos/etcd/etcdserver/api/etcdhttp"
	"utils/coreos/etcd/etcdserver/api/rafthttp"
	"utils/coreos/etcd/etcdserver/api/v2http"
	"utils/coreos/etcd/etcdserver/api/v3client"
	"utils/coreos/etcd/etcdserver/api/v3election"
	epb "utils/coreos/etcd/etcdserver/api/v3election/v3electionpb"
	"utils/coreos/etcd/etcdserver/api/v3lock"
	lockpb "utils/coreos/etcd/etcdserver/api/v3lock/v3lockpb"
	"utils/coreos/etcd/etcdserver/api/v3rpc"
	pb "utils/coreos/etcd/etcdserver/etcdserverpb"
	"utils/coreos/etcd/pkg/testutil"
	"utils/coreos/etcd/pkg/tlsutil"
...
func (c *cluster) removeMember(t *testing.T, id uint64) error {
	...
	for _, m := range c.Members {
		if uint64(m.s.ID()) != id {
			...
			// blocking on https://utils/golang/go/issues/9524
