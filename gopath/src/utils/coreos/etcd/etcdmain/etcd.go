...
import (
	...
	pkgioutil "utils/coreos/etcd/pkg/ioutil"
	"utils/coreos/etcd/pkg/osutil"
	"utils/coreos/etcd/pkg/transport"
	"utils/coreos/etcd/pkg/types"
	"utils/coreos/etcd/proxy/httpproxy"
...
var plog = capnslog.NewPackageLogger("utils/coreos/etcd", "etcdmain")
