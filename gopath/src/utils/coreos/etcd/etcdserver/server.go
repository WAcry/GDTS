...
import (
	...
	"utils/coreos/etcd/auth"
	"utils/coreos/etcd/etcdserver/api"
	"utils/coreos/etcd/etcdserver/api/membership"
	"utils/coreos/etcd/etcdserver/api/rafthttp"
	"utils/coreos/etcd/etcdserver/api/snap"
	"utils/coreos/etcd/etcdserver/api/v2discovery"
	"utils/coreos/etcd/etcdserver/api/v2http/httptypes"
	stats "utils/coreos/etcd/etcdserver/api/v2stats"
	"utils/coreos/etcd/etcdserver/api/v2store"
	"utils/coreos/etcd/etcdserver/api/v3alarm"
	"utils/coreos/etcd/etcdserver/api/v3compactor"
	pb "utils/coreos/etcd/etcdserver/etcdserverpb"
	"utils/coreos/etcd/lease"
	"utils/coreos/etcd/lease/leasehttp"
	"utils/coreos/etcd/mvcc"
	"utils/coreos/etcd/mvcc/backend"
	"utils/coreos/etcd/pkg/fileutil"
	"utils/coreos/etcd/pkg/idutil"
	"utils/coreos/etcd/pkg/pbutil"
	"utils/coreos/etcd/pkg/runtime"
	"utils/coreos/etcd/pkg/schedule"
	"utils/coreos/etcd/pkg/types"
	"utils/coreos/etcd/pkg/wait"
	"utils/coreos/etcd/raft"
	"utils/coreos/etcd/raft/raftpb"
	"utils/coreos/etcd/version"
	"utils/coreos/etcd/wal"

	"go.uber.org/zap"
	"utils/coreos/go-semver/semver"
	"utils/coreos/pkg/capnslog"
...
var (
	plog = capnslog.NewPackageLogger("utils/coreos/etcd", "etcdserver")
