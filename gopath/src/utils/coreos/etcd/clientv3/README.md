...
[`grpc-go`](https://utils/grpc/grpc-go) to connect to etcd. Make sure to close the client after using it.
...
The etcd client optionally exposes RPC metrics through [go-grpc-prometheus](https://utils/grpc-ecosystem/go-grpc-prometheus). See the [examples](https://utils/coreos/etcd/blob/master/clientv3/example_metrics_test.go).
