...
- Add [`etcd_mvcc_hash_rev_duration_seconds`](https://utils/coreos/etcd/pull/9761) Prometheus metric.
...
- Add [`WatchRequest.WatchProgressRequest`](https://utils/coreos/etcd/pull/9869).
