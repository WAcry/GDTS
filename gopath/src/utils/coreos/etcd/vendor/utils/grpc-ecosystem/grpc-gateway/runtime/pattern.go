...
import (
	...
	"utils/grpc-ecosystem/grpc-gateway/utilities"
...
// Pattern is a template pattern of http request paths defined in utils/googleapis/googleapis/google/api/http.proto.
type Pattern struct {
