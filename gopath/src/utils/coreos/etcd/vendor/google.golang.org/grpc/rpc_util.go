...
// https://utils/grpc/grpc/blob/master/doc/wait-for-ready.md.
//
...
// https://utils/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md#requests for
// more details.
//
...
type parser struct {
	...
	// https://utils/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md
	header [5]byte
}
