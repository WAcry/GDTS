...
running(leaking) after all tests.
	...
	import "utils/coreos/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "utils/coreos/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "utils/coreos/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
