...
var plog = capnslog.NewPackageLogger("utils/coreos/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// See https://utils/grpc/grpc-go/issues/1384#issuecomment-317124531
	// and https://utils/coreos/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
