...
import (
	...
	"utils/coreos/etcd/etcdserver"
	"utils/coreos/etcd/etcdserver/api/v3client"
	"utils/coreos/etcd/etcdserver/api/v3election"
	"utils/coreos/etcd/etcdserver/api/v3election/v3electionpb"
	v3electiongw "utils/coreos/etcd/etcdserver/api/v3election/v3electionpb/gw"
	"utils/coreos/etcd/etcdserver/api/v3lock"
	"utils/coreos/etcd/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "utils/coreos/etcd/etcdserver/api/v3lock/v3lockpb/gw"
	"utils/coreos/etcd/etcdserver/api/v3rpc"
	etcdservergw "utils/coreos/etcd/etcdserver/etcdserverpb/gw"
	"utils/coreos/etcd/pkg/debugutil"
	"utils/coreos/etcd/pkg/httputil"
	"utils/coreos/etcd/pkg/transport"

	"go.uber.org/zap"
	"golang.org/x/net/trace"
	"google.golang.org/grpc"
	"google.golang.org/grpc/credentials"
	gw "utils/grpc-ecosystem/grpc-gateway/runtime"
	"utils/soheilhy/cmux"
	"utils/tmc/grpc-websocket-proxy/wsproxy"
)
...
func (ac *accessController) ServeHTTP(rw http.ResponseWriter, req *http.Request) {
	...
	if req.TLS == nil { // check origin if client connection is not secure
		...
		if !ac.s.AccessController.IsHostWhitelisted(host) {
			...
			// https://utils/golang/go/commit/4b8a7eafef039af1834ef9bfa879257c4a72b7b5
...
// https://utils/transmission/transmission/pull/468
