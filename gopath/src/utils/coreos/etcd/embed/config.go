...
import (
	...
	"utils/coreos/etcd/pkg/flags"
	"utils/coreos/etcd/pkg/netutil"
	"utils/coreos/etcd/pkg/srv"
...
type Config struct {
	...
	//
	// See https://utils/coreos/etcd/issues/9333 for more detail.
	...
	// - https://utils/coreos/etcd/issues/9353
