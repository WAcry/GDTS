...
[![Go Report Card](https://goreportcard.com/badge/utils/coreos/etcd?style=flat-square)](https://goreportcard.com/report/utils/coreos/etcd)
...
[![Godoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://godoc.org/utils/coreos/etcd)
[![Releases](https://img.shields.io/github/release/coreos/etcd/all.svg?style=flat-square)](https://utils/coreos/etcd/releases)
[![LICENSE](https://img.shields.io/github/license/coreos/etcd.svg?style=flat-square)](https://utils/coreos/etcd/blob/master/LICENSE)
...
For more installation guides, please check out [play.etcd.io](http://play.etcd.io) and [operating etcd](https://utils/coreos/etcd/tree/master/Documentation#operating-etcd-clusters).
...
First install [goreman](https://utils/mattn/goreman), which manages Procfile-based applications.
...
To run an etcd cluster on Kubernetes, try [etcd operator](https://utils/coreos/etcd-operator).
...
- Planning/Roadmap: [milestones](https://utils/coreos/etcd/milestones), [roadmap](./ROADMAP.md)
- Bugs: [issues](https://utils/coreos/etcd/issues)
