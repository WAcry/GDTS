...
A simple example application, _raftexample_, is also available to help illustrate how to use this package in practice: https://utils/coreos/etcd/tree/master/contrib/raftexample
...
- [cockroachdb](https://utils/cockroachdb/cockroach) A Scalable, Survivable, Strongly-Consistent SQL Database
- [dgraph](https://utils/dgraph-io/dgraph) A Scalable, Distributed, Low Latency, High Throughput Graph Database
- [etcd](https://utils/coreos/etcd) A distributed reliable key-value store
- [tikv](https://utils/pingcap/tikv) A Distributed transactional key value database powered by Rust and Raft
- [swarmkit](https://utils/docker/swarmkit) A toolkit for orchestrating distributed systems at any scale.
- [chain core](https://utils/chain/chain) Software for operating permissioned, multi-asset blockchain networks
