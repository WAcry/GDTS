...
Previous change logs can be found at [CHANGELOG-3.4](https://utils/coreos/etcd/blob/master/CHANGELOG-3.4.md).


## v3.5.0 (TBD 2018-12)

See [code changes](https://utils/coreos/etcd/compare/v3.4.0...v3.5.0) and [v3.5 upgrade guide](https://utils/coreos/etcd/blob/master/Documentation/upgrades/upgrade_3_5.md) for any breaking changes. **Again, before running upgrades from any previous release, please make sure to read change logs below and [v3.5 upgrade guide](https://utils/coreos/etcd/blob/master/Documentation/upgrades/upgrade_3_5.md).**

### Breaking Changes

- [gRPC gateway](https://utils/grpc-ecosystem/grpc-gateway) only supports [`/v3`](TODO) endpoint.
  - Deprecated [`/v3beta`](https://utils/coreos/etcd/pull/9298).
