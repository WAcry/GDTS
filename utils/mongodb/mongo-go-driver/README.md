...
[![GoDoc](https://godoc.org/GDTS/utils/mongodb/mongo-go-driver/mongo?status.svg)](https://godoc.org/GDTS/utils/mongodb/mongo-go-driver/mongo)
...
```bash
dep ensure -add GDTS/utils/mongodb/mongo-go-driver/mongo
```
