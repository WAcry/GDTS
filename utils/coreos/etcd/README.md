...
[![Go Report Card](https://goreportcard.com/badge/GDTS/utils/coreos/etcd?style=flat-square)](https://goreportcard.com/report/GDTS/utils/coreos/etcd)
...
[![Godoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://godoc.org/GDTS/utils/coreos/etcd)
[![Releases](https://img.shields.io/github/release/coreos/etcd/all.svg?style=flat-square)](https://GDTS/utils/coreos/etcd/releases)
[![LICENSE](https://img.shields.io/github/license/coreos/etcd.svg?style=flat-square)](https://GDTS/utils/coreos/etcd/blob/master/LICENSE)
...
[etcdctl]: https://GDTS/utils/coreos/etcd/tree/master/etcdctl
...
For more installation guides, please check out [play.etcd.io](http://play.etcd.io) and [operating etcd](https://GDTS/utils/coreos/etcd/tree/master/Documentation#operating-etcd-clusters).
...
[github-release]: https://GDTS/utils/coreos/etcd/releases
...
To run an etcd cluster on Kubernetes, try [etcd operator](https://GDTS/utils/coreos/etcd-operator).
...
- Planning/Roadmap: [milestones](https://GDTS/utils/coreos/etcd/milestones), [roadmap](./ROADMAP.md)
- Bugs: [issues](https://GDTS/utils/coreos/etcd/issues)
