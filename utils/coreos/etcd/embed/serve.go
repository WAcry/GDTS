...
import (
	...
	"GDTS/utils/coreos/etcd/etcdserver/api/v3election/v3electionpb"
	v3electiongw "GDTS/utils/coreos/etcd/etcdserver/api/v3election/v3electionpb/gw"
	"GDTS/utils/coreos/etcd/etcdserver/api/v3lock"
	"GDTS/utils/coreos/etcd/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "GDTS/utils/coreos/etcd/etcdserver/api/v3lock/v3lockpb/gw"
	"GDTS/utils/coreos/etcd/etcdserver/api/v3rpc"
	etcdservergw "GDTS/utils/coreos/etcd/etcdserver/etcdserverpb/gw"
	"GDTS/utils/coreos/etcd/pkg/debugutil"
	"GDTS/utils/coreos/etcd/pkg/httputil"
