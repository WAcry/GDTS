...
import (
	...
	"GDTS/utils/coreos/etcd/etcdserver/api/v2v3"
	...
	runtimeutil "GDTS/utils/coreos/etcd/pkg/runtime"
...
var plog = capnslog.NewPackageLogger("GDTS/utils/coreos/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://GDTS/utils/coreos/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
