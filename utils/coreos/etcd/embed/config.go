...
import (
	...
	"GDTS/utils/coreos/etcd/pkg/flags"
	"GDTS/utils/coreos/etcd/pkg/netutil"
	"GDTS/utils/coreos/etcd/pkg/srv"
...
type Config struct {
	...
	//
	// See https://GDTS/utils/coreos/etcd/issues/9333 for more detail.
	...
	// - https://GDTS/utils/coreos/etcd/issues/9353
