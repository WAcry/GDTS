...
import (
	...
	"GDTS/utils/coreos/etcd/auth"
	"GDTS/utils/coreos/etcd/etcdserver/api"
	"GDTS/utils/coreos/etcd/etcdserver/api/membership"
	"GDTS/utils/coreos/etcd/etcdserver/api/rafthttp"
	"GDTS/utils/coreos/etcd/etcdserver/api/snap"
	"GDTS/utils/coreos/etcd/etcdserver/api/v2discovery"
	"GDTS/utils/coreos/etcd/etcdserver/api/v2http/httptypes"
	stats "GDTS/utils/coreos/etcd/etcdserver/api/v2stats"
	"GDTS/utils/coreos/etcd/etcdserver/api/v2store"
	"GDTS/utils/coreos/etcd/etcdserver/api/v3alarm"
	"GDTS/utils/coreos/etcd/etcdserver/api/v3compactor"
	pb "GDTS/utils/coreos/etcd/etcdserver/etcdserverpb"
	"GDTS/utils/coreos/etcd/lease"
	"GDTS/utils/coreos/etcd/lease/leasehttp"
	"GDTS/utils/coreos/etcd/mvcc"
	"GDTS/utils/coreos/etcd/mvcc/backend"
	"GDTS/utils/coreos/etcd/pkg/fileutil"
	"GDTS/utils/coreos/etcd/pkg/idutil"
	"GDTS/utils/coreos/etcd/pkg/pbutil"
	"GDTS/utils/coreos/etcd/pkg/runtime"
	"GDTS/utils/coreos/etcd/pkg/schedule"
	"GDTS/utils/coreos/etcd/pkg/types"
	"GDTS/utils/coreos/etcd/pkg/wait"
	"GDTS/utils/coreos/etcd/raft"
	"GDTS/utils/coreos/etcd/raft/raftpb"
	"GDTS/utils/coreos/etcd/version"
	"GDTS/utils/coreos/etcd/wal"

	"github.com/coreos/go-semver/semver"
	"github.com/coreos/pkg/capnslog"
	"go.uber.org/zap"
	humanize "utils/dustin/go-humanize"
)
...
var (
	plog = capnslog.NewPackageLogger("GDTS/utils/coreos/etcd", "etcdserver")
