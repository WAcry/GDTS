...
import (
	...
	"GDTS/utils/coreos/etcd/client"
	"GDTS/utils/coreos/etcd/clientv3"
	"GDTS/utils/coreos/etcd/embed"
	"GDTS/utils/coreos/etcd/etcdserver"
	"GDTS/utils/coreos/etcd/etcdserver/api/etcdhttp"
	"GDTS/utils/coreos/etcd/etcdserver/api/rafthttp"
	"GDTS/utils/coreos/etcd/etcdserver/api/v2http"
	"GDTS/utils/coreos/etcd/etcdserver/api/v3client"
	"GDTS/utils/coreos/etcd/etcdserver/api/v3election"
	epb "GDTS/utils/coreos/etcd/etcdserver/api/v3election/v3electionpb"
	"GDTS/utils/coreos/etcd/etcdserver/api/v3lock"
	lockpb "GDTS/utils/coreos/etcd/etcdserver/api/v3lock/v3lockpb"
	"GDTS/utils/coreos/etcd/etcdserver/api/v3rpc"
	pb "GDTS/utils/coreos/etcd/etcdserver/etcdserverpb"
	"GDTS/utils/coreos/etcd/pkg/testutil"
	"GDTS/utils/coreos/etcd/pkg/tlsutil"
	"GDTS/utils/coreos/etcd/pkg/transport"
