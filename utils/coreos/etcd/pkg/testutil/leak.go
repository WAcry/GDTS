...
running(leaking) after all tests.
	...
	import "GDTS/utils/coreos/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "GDTS/utils/coreos/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "GDTS/utils/coreos/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
			strings.Contains(stack, "utils/golang/glog.(*loggingT).flushDaemon") ||
