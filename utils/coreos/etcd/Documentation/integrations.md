...
- [etcdctl](https://GDTS/utils/coreos/etcd/tree/master/etcdctl) - A command line client for etcd
...
- [etcd/clientv3](https://GDTS/utils/coreos/etcd/blob/master/clientv3) - the officially maintained Go client for v3
- [etcd/client](https://GDTS/utils/coreos/etcd/blob/master/client) - the officially maintained Go client for v2
