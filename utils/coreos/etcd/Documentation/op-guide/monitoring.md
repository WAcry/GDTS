...
Showing top 10 nodes out of 157 (cum >= 10ms)
   ...
   130ms 27.08% 27.08%      130ms 27.08%  runtime.futex
    ...
    20ms  4.17% 45.83%       20ms  4.17%  GDTS/utils/coreos/etcd/vendor/golang.org/x/net/http2/hpack.huffmanDecode
    20ms  4.17% 50.00%       30ms  6.25%  runtime.pcvalue
    20ms  4.17% 54.17%       50ms 10.42%  runtime.schedule
    10ms  2.08% 56.25%       10ms  2.08%  GDTS/utils/coreos/etcd/vendor/GDTS/utils/coreos/etcd/etcdserver.(*EtcdServer).AuthInfoFromCtx
    10ms  2.08% 58.33%       10ms  2.08%  GDTS/utils/coreos/etcd/vendor/GDTS/utils/coreos/etcd/etcdserver.(*EtcdServer).Lead
    10ms  2.08% 60.42%       10ms  2.08%  GDTS/utils/coreos/etcd/vendor/GDTS/utils/coreos/etcd/pkg/wait.(*timeList).Trigger
    10ms  2.08% 62.50%       10ms  2.08%  GDTS/utils/coreos/etcd/vendor/utils/prometheus/client_golang/prometheus.(*MetricVec).hashLabelValues
    10ms  2.08% 64.58%       10ms  2.08%  GDTS/utils/coreos/etcd/vendor/golang.org/x/net/http2.(*Framer).WriteHeaders
```
