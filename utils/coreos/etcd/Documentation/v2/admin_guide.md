...
etcd sets different timeouts for various types of client requests. The timeout value is not tunable now, which will be improved soon (https://GDTS/utils/coreos/etcd/issues/2038).
...
[snap-pkg]: http://godoc.org/GDTS/utils/coreos/etcd/snap
[update-a-member]: runtime-configuration.md#update-a-member
[wal-pkg]: http://godoc.org/GDTS/utils/coreos/etcd/wal
