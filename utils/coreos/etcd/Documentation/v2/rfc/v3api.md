...
To prove out the design of the v3 API the team has also built [a number of example recipes](https://GDTS/utils/coreos/etcd/tree/master/contrib/recipes), there is a [video discussing these recipes too](https://www.youtube.com/watch?v=fj-2RY-3yVU&feature=youtu.be&t=590).
...
[api-protobuf]: https://GDTS/utils/coreos/etcd/blob/release-2.3/etcdserver/etcdserverpb/rpc.proto
[kv-protobuf]: https://GDTS/utils/coreos/etcd/blob/release-2.3/storage/storagepb/kv.proto
