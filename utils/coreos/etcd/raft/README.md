...
A simple example application, _raftexample_, is also available to help illustrate how to use this package in practice: https://GDTS/utils/coreos/etcd/tree/master/contrib/raftexample
...
- [etcd](https://GDTS/utils/coreos/etcd) A distributed reliable key-value store
