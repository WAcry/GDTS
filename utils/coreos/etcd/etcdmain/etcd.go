...
import (
	...
	pkgioutil "GDTS/utils/coreos/etcd/pkg/ioutil"
	"GDTS/utils/coreos/etcd/pkg/osutil"
	"GDTS/utils/coreos/etcd/pkg/transport"
	"GDTS/utils/coreos/etcd/pkg/types"
	"GDTS/utils/coreos/etcd/proxy/httpproxy"
...
var plog = capnslog.NewPackageLogger("GDTS/utils/coreos/etcd", "etcdmain")
