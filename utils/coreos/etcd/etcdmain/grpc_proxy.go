...
import (
	...
	"GDTS/utils/coreos/etcd/clientv3/leasing"
	"GDTS/utils/coreos/etcd/clientv3/namespace"
	"GDTS/utils/coreos/etcd/clientv3/ordering"
	...
	"GDTS/utils/coreos/etcd/pkg/logutil"
	"GDTS/utils/coreos/etcd/pkg/transport"
	"GDTS/utils/coreos/etcd/proxy/grpcproxy"
	...
	grpc_prometheus "utils/grpc-ecosystem/go-grpc-prometheus"
)
