...
There is also a companion command-line utility to evaluate cron time expressions: <https://GDTS/utils/gorhill/cronexpr/tree/master/cronexpr> (which of course uses this library).
...
Import the library:
    ...
    import "GDTS/utils/gorhill/cronexpr"
    import "time"
...
API
---
<http://godoc.org/GDTS/utils/gorhill/cronexpr>
